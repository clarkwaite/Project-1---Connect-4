...
$(document).ready(function () {
    ...
    var con8 = [$('#36'), $('#30'), $('#24'), $('#18'), $('#12'), $('#6')];
    var con9 = [$('#37'), $('#31'), $('#25'), $('#19'), $('#13'), $('#7')];
    var con10 = [$('#41'), $('#33'), $('#25'), $('#17'), $('#9'), $('#1')];
    var con11 = [$('#42'), $('#34'), $('#26'), $('#18'), $('#10'), $('#2')];
    ...
    var con17 = [$('#36'), $('#37'), $('#38'), $('#39'), $('#40'), $('#41'), $('#42')];

    var con18 = [$('#29'), $('#23'), $('#17'), $('#11'), $('#5')];
    var con19 = [$('#38'), $('#32'), $('#26'), $('#20'), $('#14')];
    var con20 = [$('#40'), $('#32'), $('#24'), $('#16'), $('#8')];
    var con21 = [$('#35'), $('#27'), $('#19'), $('#11'), $('#3')];

    var con22 = [$('#39'), $('#33'), $('#27'), $('#21')];
    var con23 = [$('#39'), $('#31'), $('#23'), $('#15')];
    var con24 = [$('#28'), $('#20'), $('#12'), $('#4')];
    var con25 = [$('#22'), $('#16'), $('#10'), $('#4')];

    var checkRed = 0;
    var checkBlack = 0;
    var variables = [con1, con2, con3, con4, con5, con6, con7];
    var variablesTwo = [con8, con9, con10, con11, con12, con13, con14, con15, con16, con17, con18, con19, con20, con21, con22, con23, con24, con25];

    function winConditions() {
        for (var i = 0; i < con1.length; i++) {
            for (var j = 0; j < variables.length; j++) {
                if (variables[j][i].attr('class') === 'redCircle') {
                    checkBlack = 0 && checkRed++;
                    console.log(checkBlack + '  ' + checkRed)
                    if (checkRed === 4) {
                        alert('Red Wins!');
                    } else if (variables[j][i].className === 'blackCircle') {
